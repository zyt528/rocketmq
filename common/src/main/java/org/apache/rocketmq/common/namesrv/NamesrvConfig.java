...
public class NamesrvConfig {
    ...
    private String kvConfigPath = System.getProperty("ROCKETMQ_HOME") + File.separator + "namesrv" + File.separator + "kvConfig.json";
//    private String kvConfigPath = System.getProperty("user.home") + File.separator + "namesrv" + File.separator + "kvConfig.json";
    private String configStorePath = System.getProperty("ROCKETMQ_HOME") + File.separator + "namesrv" + File.separator + "namesrv.properties";
